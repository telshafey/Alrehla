...
import { CreativeWritingPackage } from '../../../lib/database.types.ts';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {packages.map(pkg => (
                    <button
                        ...
                        className={`p-6 border-2 rounded-2xl text-right transition-all hover:shadow-lg hover:border-blue-500 ${pkg.popular ? 'border-blue-500 bg-blue-50' : 'border-gray-200'}`}
                    >
                        ...
                        <p className="text-3xl font-extrabold my-3">{pkg.price} ج.م</p>
