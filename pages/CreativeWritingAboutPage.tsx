...
const FeatureCard: React.FC<{ icon: React.ReactNode; title: string; description: string; }> = ({ icon, title, description }) => (
    <div className="flex items-start gap-4 p-6 bg-white rounded-2xl border">
        ...
        <div className="bg-white animate-fadeIn">
            ...
            <section className="bg-blue-50 py-16 sm:py-20">
                 <div className="container mx-auto px-4">
                    <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">{content?.philosophyTitle}</h2>
