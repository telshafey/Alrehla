...
import { ArrowLeft, Save, User, Lock, Shield, Briefcase, GraduationCap, Link as LinkIcon, Users, AlertTriangle } from 'lucide-react';
    ...
    return (
        <div className="animate-fadeIn space-y-8 max-w-4xl mx-auto">
            ...
            <div className="flex justify-between items-center">
                ...
                <Button type="submit" form="user-form" loading={isSaving} icon={<Save />}>حفظ</Button>
            </div>
