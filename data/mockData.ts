...
export const mockSiteContent: SiteContent = {
    ...
    privacyPage: {
        ...
        content: `في منصة الرحلة ("نحن"، "المنصة")، خصوصيتك هي أولويتنا القصوى.\n\n1. المعلومات التي نجمعها\nنجمع أنواعًا مختلفة من المعلومات لتقديم خدماتنا المخصصة:\n- معلومات الحساب: عند التسجيل، نطلب الاسم والبريد الإلكتروني.\n- معلومات التخصيص: اسم الطفل، عمره، اهتماماته وصوره.\n\n2. كيف نستخدم معلوماتك\nنستخدم المعلومات لغرض وحيد وهو تقديم وتخصيص خدماتنا (تأليف القصص، إدارة الجلسات) وللتواصل معك بخصوص طلباتك.\n\n3. مشاركة المعلومات\nنحن لا نبيع بياناتك. نشارك المعلومات فقط مع مزودي الخدمات الضروريين (مثل شركات الشحن) أو عند الضرورة القانونية.\n\n4. أمان البيانات\nنتخذ كافة التدابير الأمنية الممكنة لحماية بياناتك من الوصول غير المصرح به.`
    },
    termsPage: {
        title: 'شروط الاستخدام',
        content: `مرحباً بك في منصة الرحلة.\n\n1. الموافقة على الشروط\nباستخدامك للمنصة، فإنك توافق على الالتزام بهذه الشروط.\n\n2. حسابات المستخدمين\nأنت مسؤول عن الحفاظ على سرية حسابك وكلمة المرور. يجب تقديم معلومات دقيقة عند التسجيل.\n\n3. الملكية الفكرية\nجميع المحتويات الأصلية للمنصة هي ملك لمنصة الرحلة. المحتوى الذي ينشئه الطالب في جلسات الكتابة يظل ملكية فكرية للطالب.\n\n4. سياسة الإلغاء\nيمكن إلغاء طلبات المنتجات قبل بدء الطباعة. يمكن إلغاء جلسات التدريب قبل 24 ساعة من موعدها.`
    },
    footer: {
